...
-- Phrase 2
INSERT INTO phrases(id, iso_language_code, phrase, status, transcription, embedding)
VALUES ('7a2d8b5c-4f1e-4c7a-9d3b-8f2e1a9c3d4e', 'hy', 'Բարև ձեզ', 'DRAFT', 'Barev dzez', array_fill(0, ARRAY[1536])::vector);
...
-- Phrase 3
INSERT INTO phrases(id, iso_language_code, phrase, status, transcription, embedding)
VALUES ('d4e5f6a1-b2c3-4d5e-9f7a-8b9c0d1e2f3a', 'hy', 'Ինչպե՞ս եք:', 'DRAFT', 'Inchpes eq?', array_fill(0, ARRAY[1536])::vector);
