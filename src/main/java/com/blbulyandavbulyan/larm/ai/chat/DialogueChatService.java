    ...
    public StructuredDialogueResource dialogueChat(String message, UUID chatId) {
        ...
        try {
            return chatClient.prompt()
                    ...
                    .user(message)
                    // the idea of injection several logging advisors is to see what happens in between them
